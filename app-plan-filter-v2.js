...
function renderAnnualPlan(){
 ...
 head.innerHTML=`<tr><th rowspan="3">STT<br>No.</th><th rowspan="3">TÊN MMTB / HỆ THỐNG<br>Name</th><th rowspan="3">MÃ TÀI SẢN<br>Asset</th><th rowspan="3">NGÀY LẮP ĐẶT<br>Installation date</th><th rowspan="3">CHU KỲ BẢO DƯỠNG<br>Maintenance cycle</th><th colspan="24">THỜI GIAN BẢO TRÌ NĂM ${y} / MAINTENANCE PERIOD</th></tr><tr>${Array.from({length:12},(_,m)=>`<th colspan="2">${m+1}<br><small>${['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][m]}</small></th>`).join('')}</tr><tr>${Array.from({length:12},()=>'<th>KH<br>Plan</th><th>TH<br>Actual</th>').join('')}</tr>`;
